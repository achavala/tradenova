...
Main entry point - loads Dashboard page content
"""
...
# Redirect to Dashboard page to avoid duplicate navigation
# The main dashboard.py will redirect, so only the page version shows in nav
...
# Main content - same as Dashboard page
